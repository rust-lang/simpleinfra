...
> [!NOTE]
> This project is still under active development and it's not finished yet.

s3-tsv-lambda is a Rust AWS Lambda function that lists all the objects in an S3
bucket in a tsv file, and writes the file in the bucket.
